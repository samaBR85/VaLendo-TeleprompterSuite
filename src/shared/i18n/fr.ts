...
export const fr: Dicionario = {
  ...
  'toolbar.freeClock.play': 'Démarrer l’horloge indépendante',
  'toolbar.freeClock.pause': 'Mettre en pause l’horloge indépendante',
  'toolbar.freeClock.restart': 'Remettre à zéro l’horloge indépendante',
  'toolbar.freeClock.label': 'à part',
  ...
  'insp.clock.modeFree': 'Indépendant',
  ...
  'insp.clock.modeFree.hint': 'Un chronomètre à part, avec son propre bouton play/pause dans la barre d’outils. Mettre en pause ou relancer le texte ne le touche jamais.',
  ...
  'cmd.transport.pauseOnly': 'Mettre en pause seulement le défilement (l’horloge indépendante continue)',
  ...
  'cmd.clock.freeToggle': 'Démarrer ou mettre en pause l’horloge indépendante',
  'cmd.clock.freeRestart': 'Remettre à zéro l’horloge indépendante',
