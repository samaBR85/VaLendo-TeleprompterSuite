...
export const fr: Dicionario = {
  ...
  'toolbar.catch': 'CATCH',
  'toolbar.catchHint': 'Le défilement suit en continu le curseur de l’éditeur, comme un Go To toujours actif',
  'toolbar.ppm': 'mpm',
  ...
  'web.audio': 'Son sur le réseau',
  'web.audioHint': 'Laisse passer le son des cartes vidéo sur cette page, ou le coupe. Le volume reste propre à chaque côté : le curseur du tiroir est ton casque, et celui qui regarde utilise son propre appareil.',
  'web.mute': 'Muet',
