...
export const fr: Dicionario = {
  ...
  'editor.colorNone': 'Retirer la marque',
  ...
  'editor.paintWith': 'Peindre en',
  'editor.applyOne': 'Appliquer ici',
  ...
  'toolbar.saveScript': 'Enregistrer le texte',
