...
export const fr: Dicionario = {
  ...
  'welcome.newHint': 'Ouvre un éditeur vide, prêt à coller ou à taper.',
  'welcome.demo': 'Voir la démo',
  'welcome.demoHint': 'Un court texte qui montre l’app en action. Supprimable ensuite.',
  'welcome.open': 'Ouvrir un projet',
  'welcome.openHint': 'Charge un fichier .valendo déjà enregistré.',
