...
export const de: Dicionario = {
  ...
  'web.intro':
    'Wer im selben WLAN ist, öffnet die Adresse im Browser und liest live mit — genau so, wie der Sprecher es sieht. Es muss nichts installiert werden.',
  ...
  'web.pointCamera': 'Kamera des Telefons darauf richten:',
  'web.copy': 'kopieren',
  'web.copied': 'kopiert',
  ...
  'web.audio': 'Ton im Netzwerk',
  'web.audioHint': 'Lässt den Ton der Videokarten auf dieser Seite durch oder unterbricht ihn. Die Lautstärke bleibt auf jeder Seite eigen: der Regler in der Schublade ist dein Kopfhörer, und wer zusieht, nutzt das eigene Gerät.',
  'web.mute': 'Stumm',
  'web.unmute': 'Ton an',
