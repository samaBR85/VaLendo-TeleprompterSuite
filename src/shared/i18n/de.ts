...
export const de: Dicionario = {
  ...
  'toolbar.freeClock.play': 'Unabhängige Uhr starten',
  'toolbar.freeClock.pause': 'Unabhängige Uhr pausieren',
  'toolbar.freeClock.restart': 'Unabhängige Uhr zurücksetzen',
  'toolbar.freeClock.label': 'unabhängig',
  ...
  'insp.clock.modeFree': 'Unabhängig',
  ...
  'insp.clock.modeFree.hint': 'Eine eigene Stoppuhr mit eigenem Play/Pause in der Werkzeugleiste. Text pausieren oder neu starten rührt sie nie an.',
  ...
  'cmd.transport.pauseOnly': 'Nur den Lauf pausieren (unabhängige Uhr läuft weiter)',
  ...
  'cmd.clock.freeToggle': 'Unabhängige Uhr starten oder pausieren',
  'cmd.clock.freeRestart': 'Unabhängige Uhr zurücksetzen',
