...
export const de: Dicionario = {
  ...
  'welcome.newHint': 'Öffnet den leeren Editor zum Einfügen oder Tippen.',
  'welcome.demo': 'Demo ansehen',
  'welcome.demoHint': 'Ein kurzes Skript, das die App in Aktion zeigt. Später löschbar.',
  'welcome.open': 'Projekt öffnen',
  'welcome.openHint': 'Lädt eine .valendo-Datei, die du gespeichert hast.',
