...
export const pt = {
  ...
  'web.audio': 'Som pela rede',
  'web.audioHint': 'Liga ou corta o áudio dos cartões de vídeo nesta página. O volume continua sendo de cada lado: o slider da gaveta é o seu fone, e quem assiste usa o botão do próprio aparelho.',
  'web.mute': 'Mudo',
