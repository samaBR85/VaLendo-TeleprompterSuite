...
export const pt = {
  ...
  'welcome.newHint': 'Abre o editor vazio, para colar ou digitar o seu texto.',
  'welcome.demo': 'Ver a demonstração',
  'welcome.demoHint': 'Um roteiro curto que mostra o app funcionando. Dá para apagar depois.',
  'welcome.open': 'Abrir um projeto',
  'welcome.openHint': 'Carrega um arquivo .valendo que você já tinha salvo.',
