...
export const pt = {
  ...
  'editor.colorNone': 'Tirar a marca',
  ...
  'toolbar.saveScript': 'Salvar roteiro',
  'toolbar.saveScriptTo': 'Salvar roteiro em {file}',
