...
export const it: Dicionario = {
  ...
  'toolbar.catch': 'CATCH',
  'toolbar.catchHint': 'Lo scorrimento segue sempre il cursore dell’editor, come un Go To sempre attivo',
  'toolbar.ppm': 'ppm',
  ...
  'web.audio': 'Audio sulla rete',
  'web.audioHint': 'Lascia uscire l’audio delle schede video su questa pagina, oppure lo taglia. Il volume resta di ciascun lato: il cursore del cassetto è la tua cuffia, e chi guarda usa il proprio apparecchio.',
  'web.mute': 'Muto',
