...
export const it: Dicionario = {
  ...
  'toolbar.exportScript': 'Esporta copione',
  'toolbar.exportScriptAs': 'Esporta con nome…',
  'toolbar.exportScriptTo': 'Esporta copione in {file}',
  ...
  'insp.weightOneFace': 'Questo carattere ha un solo spessore — cambia carattere per variarlo',
  ...
  'credits.fonts': 'Caratteri',
  'credits.fontsValue': '10 caratteri liberi · SIL OFL 1.1',
  ...
  'main.exportScriptTitle': 'Esporta copione',
