...
export const it: Dicionario = {
  ...
  'welcome.newHint': 'Apre l’editor vuoto, pronto per incollare o scrivere.',
  'welcome.demo': 'Vedi la demo',
  'welcome.demoHint': 'Un copione breve che mostra l’app al lavoro. Si può cancellare dopo.',
  'welcome.open': 'Apri un progetto',
  'welcome.openHint': 'Carica un file .valendo già salvato.',
