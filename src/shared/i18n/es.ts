...
export const es: Dicionario = {
  ...
  'toolbar.freeClock.play': 'Iniciar el reloj independiente',
  'toolbar.freeClock.pause': 'Pausar el reloj independiente',
  'toolbar.freeClock.restart': 'Poner a cero el reloj independiente',
  'toolbar.freeClock.label': 'aparte',
  ...
  'insp.clock.modeFree': 'Independiente',
  ...
  'insp.clock.modeFree.hint': 'Un cronómetro aparte, con su propio play/pausa en la barra de herramientas. Pausar o reiniciar el texto nunca lo toca.',
  ...
  'cmd.transport.pauseOnly': 'Pausar solo el desplazamiento (el reloj independiente sigue)',
  ...
  'cmd.clock.freeToggle': 'Iniciar o pausar el reloj independiente',
  'cmd.clock.freeRestart': 'Poner a cero el reloj independiente',
