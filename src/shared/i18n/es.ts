...
export const es: Dicionario = {
  ...
  'toolbar.catch': 'CATCH',
  'toolbar.catchHint': 'El desplazamiento sigue el cursor del editor todo el tiempo, como un Go To siempre activo',
  'toolbar.ppm': 'ppm',
  ...
  'web.audio': 'Sonido por la red',
  'web.audioHint': 'Deja salir el audio de las tarjetas de vídeo en esta página, o lo corta. El volumen sigue siendo de cada lado: el deslizador del cajón es tu auricular, y quien mira usa su propio aparato.',
  'web.mute': 'Silenciar',
