...
export const es: Dicionario = {
  ...
  'welcome.newHint': 'Abre el editor vacio, para pegar o escribir tu texto.',
  'welcome.demo': 'Ver la demostración',
  'welcome.demoHint': 'Un guión corto que muestra la app funcionando. Se puede borrar después.',
  'welcome.open': 'Abrir un proyecto',
  'welcome.openHint': 'Carga un archivo .valendo que ya habías guardado.',
