...
export const es: Dicionario = {
  ...
  'app.splitReset': 'Doble clic: centrar la divisoria',
  'app.onAir': 'Al aire',
  ...
  'toolbar.loopDelay': 'Espera, en segundos, antes de que el bucle reinicie la lectura',
  ...
  'cards.overlayHint':
    'El texto de la Emisión se sobrepone a esta tarjeta en vez de sustituirla. El interruptor global de la columna Assets, si está activado, fuerza esto para todas las tarjetas.',
