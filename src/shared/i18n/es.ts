...
export const es: Dicionario = {
  ...
  'editor.fontFamily': 'Fuente del editor',
  ...
  'toolbar.exportScript': 'Exportar guion',
  'toolbar.exportScriptAs': 'Exportar como…',
  'toolbar.exportScriptTo': 'Exportar guion a {file}',
  ...
  'insp.textLock': 'Bloquear ajustes de texto',

  'insp.font': 'Tipografía',
  ...
  'credits.fontsValue': '10 fuentes libres · SIL OFL 1.1',
  ...
  'main.exportScriptTitle': 'Exportar guion',
