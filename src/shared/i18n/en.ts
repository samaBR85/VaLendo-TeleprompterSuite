...
export const en: Dicionario = {
  ...
  'web.audio': 'Sound on the network',
  'web.audioHint': 'Lets video card audio out on this page, or cuts it. Volume stays with each side: the drawer slider is your headphones, and whoever is watching uses their own device.',
  'web.mute': 'Mute',
  'web.unmute': 'Unmute',
