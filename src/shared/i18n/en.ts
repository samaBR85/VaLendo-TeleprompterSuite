...
export const en: Dicionario = {
  ...
  'toolbar.freeClock.play': 'Start the independent clock',
  'toolbar.freeClock.pause': 'Pause the independent clock',
  'toolbar.freeClock.restart': 'Reset the independent clock',
  'toolbar.freeClock.label': 'standalone',
  ...
  'insp.clock.modeFree': 'Independent',
  ...
  'insp.clock.modeFree.hint': 'A separate stopwatch, started/paused from its own toolbar button. Pausing or restarting the text never touches it.',
  ...
  'cmd.transport.pauseOnly': 'Pause only the scrolling (independent clock keeps running)',
  ...
  'cmd.clock.freeToggle': 'Start or pause the independent clock',
  'cmd.clock.freeRestart': 'Reset the independent clock',
