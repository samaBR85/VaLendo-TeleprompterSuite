...
export const en: Dicionario = {
  ...
  'welcome.newHint': 'Opens an empty editor, ready for you to paste or type.',
  'welcome.demo': 'See the demo',
  'welcome.demoHint': 'A short script that shows the app at work. You can delete it later.',
  'welcome.open': 'Open a project',
  'welcome.openHint': 'Loads a .valendo file you saved before.',
