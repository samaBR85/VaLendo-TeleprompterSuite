...
export const en: Dicionario = {
  ...
  'toolbar.exportScript': 'Export script',
  'toolbar.exportScriptAs': 'Export as…',
  'toolbar.exportScriptTo': 'Export script to {file}',
  ...
  'insp.textLock': 'Lock text settings',
  ...
  'insp.weight': 'Weight',
  'insp.weightOneFace': 'This font has a single weight — change the font to vary it',
  ...
  'credits.fontsValue': '10 open fonts · SIL OFL 1.1',
  ...
  'main.exportScriptTitle': 'Export script',
